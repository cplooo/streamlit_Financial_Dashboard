# 載入必要模組
#import haohaninfo
c#from order_Lo8 import Record
import numpy as np
from talib.abstract import SMA,EMA, WMA, RSI, BBANDS, MACD
#import sys
import indicator_f_Lo2,datetime, indicator_forKBar
import pandas as pd
...
html_temp = """
		...
		<h4 style="color:white;text-align:center;">Financial Dashboard </h4>
		</div>
		"""
stc.html(html_temp)
...
## 读取Pickle文件
df = pd.read_pickle('kbars_2330_2022-01-01-2022-11-18.pkl')
...
KBar = indicator_forKBar.KBar(Date,cycle_duration)    ## 設定cycle_duration可以改成你想要的 KBar 週期
